...
const Showcase = ({ slice }: ShowcaseProps): JSX.Element => {
  return (
    ...
    >
      ...
      {/* because rich text editors follow the breaks that why using as it is and will update its components */}
      <AnimatedContent>
        <PrismicRichText
      ...
      <div className="mt-16 grid gap-8 rounded-xl border border-blue-50/20 bg-gradient-to-b from-slate-50/15 to-slate-50/5 px-8 py-8 backdrop-blur-sm lg:grid-cols-3 lg:gap-0 lg:py-12">
        <div>
